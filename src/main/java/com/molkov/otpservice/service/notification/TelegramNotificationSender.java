...
@Slf4j
@Component
public class TelegramNotificationSender implements NotificationSender, SpringLongPollingBot,
    ...
    public void send(String message, User user) {
        if (user.getTelegramId() == null) {
            log.info("Telegram id is null. Notify doesn't send");
            return;
        }
        ...
        try {
            ...
            log.info("Telegram sent message successfully: {}", sendMessage);
